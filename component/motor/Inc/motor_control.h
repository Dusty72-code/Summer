...
#define MOTOR_KP_DEFAULT 250.0f
#define MOTOR_KI_DEFAULT 100.0f
...
#define MOTOR_SELF_TEST_PWM 1500
#define MOTOR_SELF_TEST_TIME_MS 300
#define MOTOR_SELF_TEST_MIN_ENCODER 100
